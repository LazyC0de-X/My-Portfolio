        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/LazyC0de-X'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://linkedin.com/in/lazycodex'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    While I’m currently enjoying my work in my current role, I’m
                    always open to discussing new challenges and innovative
                    projects. If you have an opportunity that aligns with my
                    background, I’d love to connect! You can reach me via my
                    personal email or by using the form below.
                </p>
                <br />
                <p>
                    <b>Email: </b>
