                ...
                >
                    <div style={styles.startWindowInner}>
                        <div style={styles.verticalStartContainer}>
                            <p style={styles.verticalText}>LazyCodeX</p>
                        </div>
                        <div style={styles.startWindowContent}>
                            <div style={styles.startMenuSpace} />
                            <div style={styles.startMenuLinks}>
                                <a
                                    href="https://github.com/LazyC0de-X"
                                    target="_blank"
                                    rel="noreferrer"
                                    style={styles.startMenuLink}
                                >
                                    <img
                                        src={ghIcon}
                                        alt="GitHub"
                                        style={styles.startMenuIconImage}
                                    />
                                    <span style={styles.startMenuLinkText}>
                                        GitHub
                                    </span>
                                </a>
                                <a
                                    href="https://linkedin.com/in/lazycodex"
                                    target="_blank"
                                    rel="noreferrer"
                                    style={styles.startMenuLink}
                                >
            ...
            <div style={styles.toolbarInner}>
                ...
                <div style={styles.time}>                    
                    ...
                    <div
                        ...
                        onMouseDown={openCredits}
                    >
                        <Icon style={styles.creditsIcon} icon="credits" />
                        <p style={styles.actionText}>Credits</p>
                    </div>
